...
func setupRouter() *chi.Mux {
	...
	r.Post("/auth/login", func(w http.ResponseWriter, r *http.Request) {
		...
		// Use the auth method ID from request, falling back to default
		selectedAuthMethodID := authMethodID
		if req.AuthMethodID != "" {
			selectedAuthMethodID = req.AuthMethodID
		}
		...
		result, err := amClient.Authenticate(r.Context(), selectedAuthMethodID, "login", params)
		if err != nil {
